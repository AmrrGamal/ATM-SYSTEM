  ...
  if(!empty($_POST['oldpassword'])){
    ...
    if($_POST['oldpassword'] == $_SESSION["userpassword"] ){
      ...
      echo '<center><div  style="width:40%; background:#e69d5e; font:800px" class="alert alert-danger" role="alert">
          <center> <h4 style="font-weight:bold;font-size:25px">"You have entered wrong Password"</h4></center> </center>
        </div>';
          header("refresh:2;");
    ...
    echo '<center><div  style="width:40%; background:#e69d5e; font:800px" class="alert alert-danger" role="alert">
    <center> <h4 style="font-weight:bold;font-size:25px">"Please Enter the Password"</h4></center> </center>
  </div>';
    header("refresh:2;");
...
<div class="row">
  <h2 style="text-align: center;font-size:40px">Please enter your Current Password: </h2>
</div>
<form method="post">
<?php
      if(isset($error)){
      ...
      ?>
<p align="center"><input name='oldpassword'  id="tbInput" class="PINtext" readonly   type="text" placeholder="Current Password" maxlength="5"/></p>
