...
if(isset($_POST['submit'])){
  if(!empty($_POST['confirmnewPassword'])){
    if($_POST['confirmnewPassword'] == $_SESSION['newPassword']){
      ...
      if($change->changePassword($person)){
        ...
        echo '<center><div  style="width:40%; background:#e69d5e; font:800px" class="alert alert-danger" role="alert">
            <center> <h4 style="font-weight:bold;font-size:25px">The Password you entered is not valid!</h4></center> </center>
            </div>';
            header("refresh:2;");
        ...
        echo '<center><div  style="width:40%; background:#e69d5e; font:800px" class="alert alert-danger" role="alert">
            <center> <h4 style="font-weight:bold;font-size:25px">The Password you entered does not match!</h4></center> </center>
            </div>';
            header("refresh:2;");
    ...
    echo '<center><div  style="width:40%; background:#e69d5e; font:800px" class="alert alert-danger" role="alert">
        <center> <h4 style="font-weight:bold;font-size:25px"> Please Enter New Password</h4></center> </center>
        </div>';
        header("refresh:2;");
...
<div class="row">
  <h2 style="text-align: center;font-size:40px">Please confirm your New Password: </h2>
</div>
...
<?php
      ...
      ?>
<p align="center"><input  id="tbInput" name="confirmnewPassword" readonly class="PINtext"  type="text" placeholder="Confirm Password" minlength="5"/></p>
...
<a href="confirmChangePass.php" style="" class="btn btn-danger btn-lg returnCardButton">Back</a>
